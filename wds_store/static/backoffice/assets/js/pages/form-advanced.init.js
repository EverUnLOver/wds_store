$(document).ready(function () {
  ...
  !function (s) {
    ...
    e.prototype.init = function () {
      ...
      }), s(".colorpicker-default").colorpicker({format: "hex"}), s(".colorpicker-rgba").colorpicker(), s("#colorpicker-horizontal").colorpicker({
        color: "#88cc33",
        horizontal: !0
    ...
    "use strict";
    var o = $(".docs-date"), r = $(".docs-datepicker-container"), c = $(".docs-datepicker-trigger"), l = {
      show: function (e) {
    ...
    o.on({
      ...
      var t, a = e.target, i = $(a), s = i.attr("name"), n = "checkbox" === a.type ? a.checked : i.val();
      switch (s) {
        case"container":
          n ? (n = r).show() : r.hide();
          break;
